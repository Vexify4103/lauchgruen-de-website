...
export type TeamSlot = { kind: "team"; name: string } | { kind: "groupSeed"; seed: number } | { kind: "matchWinner"; matchId: string } | { kind: "matchLoser"; matchId: string };
...
export const azLetterPools = ["A", "B-D", "E-G", "H-J", "K", "L-M", "N-P", "Q, R und U", "S", "V und X", "T und W", "Y und Z"];
...
export const tournamentCurrentHighlights = [
	...
	"Gespielte Pools bleiben bis Upper Final beziehungsweise Lower Semi-Final im Team-Rad gesperrt. Erst für diese vier Teams beginnt ein frischer Final-Pool-Zyklus.",
...
function player(name: string, role: TournamentPlayer["role"], riotId = `${name}#EUW`): TournamentPlayer {
...
function roundRobin(group: "A" | "B", teamNames: [string, string, string, string]): GroupMatch[] {
...
export const playoffMatches: PlayoffMatch[] = [
	{
		...
		time: "Richtzeit 16:00 · rollierend",
		teamA: seed(3),
		teamB: seed(6),
		status: "Locked",
	},
	...
	},
	{
		...
		time: "Richtzeit 17:00 · rollierend",
		teamA: seed(2),
	...
	},
	{
		...
		time: "Richtzeit 18:00 · rollierend",
	...
	},
	{
		...
		time: "Richtzeit 19:00 · rollierend",
	...
	},
	{
		...
		time: "Richtzeit 20:00 · rollierend",
...
export const rankOptions = ["Unranked", "Iron", "Bronze", "Silver", "Gold", "Platinum", "Emerald", "Diamond", "Master", "Grandmaster", "Challenger"];
