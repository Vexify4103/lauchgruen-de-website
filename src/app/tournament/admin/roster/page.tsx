...
export default async function RosterPage() {
	...
	const [snapshot, version] = await Promise.all([loadRosterSnapshot(), getAdminVersion("roster")]);
			...
			<section className="mx-auto w-full max-w-7xl">
				<div className="flex flex-wrap items-end justify-between gap-3">
					<div className="max-w-3xl">
						<div className="text-xs font-black uppercase tracking-[0.3em] text-lime-200/64">Roster-Builder</div>
						<h1 className="mt-3 text-4xl font-black tracking-tight text-emerald-50 sm:text-5xl">Spielerteams einteilen</h1>
						<p className="mt-4 text-sm leading-7 text-emerald-100/68">Klicke einen leeren Rollen-Slot, um einen Spieler zuzuweisen</p>
					</div>
					<Link
