		...
		<div className="px-5 py-10 sm:py-14">
			<section className="mx-auto w-full max-w-5xl">
				<div className="rounded-[2.4rem] border border-lime-200/14 bg-gradient-to-br from-lime-200/12 via-emerald-400/8 to-cyan-400/8 p-6 shadow-2xl shadow-black/30 sm:p-8">
					<div className="text-xs font-black uppercase tracking-[0.3em] text-lime-200/64">Datenschutz</div>
					<h1 className="mt-4 text-4xl font-black tracking-tight text-emerald-50 sm:text-5xl">Welche Daten wir für das Turnier verarbeiten.</h1>
					<p className="mt-4 max-w-3xl text-sm leading-7 text-emerald-100/72">
						Diese Seite erklärt transparent, welche Daten für das Lauchgruen League-of-Legends-Turnier verarbeitet werden. Sie ist keine anwaltliche Rechtsberatung,
						sondern die praktische Datenschutzerklärung für dieses Community-Turnier.
					</p>
				</div>
				...
				<div className="mt-6 grid gap-5">
					<InfoBlock title="Wer ist verantwortlich?">
						<p>
							Verantwortlich für die Turnierorganisation ist das Lauchgruen Orga-Team. Kontakt läuft aktuell über den Lauchgruen-Discord oder direkt über Luca /
							Lauchgruen und die eingetragenen Turnieradmins.
						</p>
					</InfoBlock>
					...
					<InfoBlock title="Wer kann die Daten sehen?">
						<p>
							Bewerbungen, Notizen, Discord-IDs, PUUIDs, Admin-Notizen und Logs sind nur für berechtigte Turnieradmins sichtbar. Öffentliche Turnierseiten zeigen nur
							Daten, die für Zuschauer und Teilnehmer sinnvoll sind, zum Beispiel Teams, Riot-IDs, Rollen, Pools, Scores und Draft-Informationen.
						</p>
					</InfoBlock>

					<InfoBlock title="Externe Dienste">
						<p>
							Wir nutzen Discord für Login, Servermitgliedschaft, Rollen und den Turnierbetrieb. Riot-Daten werden serverseitig über die Riot API abgefragt. OP.GG und
							DPM werden als externe Links angezeigt; beim Anklicken gelten deren eigene Datenschutzregeln.
						</p>
					</InfoBlock>

					<InfoBlock title="Speicherdauer und Löschung">
						<p>
							Turnierdaten werden mindestens für Organisation, Nachvollziehbarkeit und Abschluss des Events gespeichert. Wenn du möchtest, dass deine Bewerbung oder
							dein Riot-Link gelöscht oder korrigiert wird, melde dich beim Orga-Team. Daten, die für Regelverstöße, Blacklist, Ergebnisnachweise oder
							Missbrauchsschutz nötig sind, können länger gespeichert werden.
						</p>
					</InfoBlock>

					<InfoBlock title="Deine Rechte">
						<p>
							Du kannst beim Orga-Team Auskunft, Korrektur oder Löschung deiner gespeicherten Bewerbungsdaten anfragen. Wenn du deinen Riot-Account trennst, werden
							der Riot-Link und die dazugehörige Bewerbung im System entfernt; Blacklist- oder Missbrauchsschutzdaten können davon ausgenommen sein.
						</p>
					</InfoBlock>
...
function InfoBlock({ title, children }: { title: string; children: ReactNode }) {
	return (
		<article className="rounded-[2rem] border border-white/10 bg-white/[0.045] p-5 text-sm leading-7 text-emerald-100/72 shadow-xl shadow-black/20">
			<h2 className="text-xs font-black uppercase tracking-[0.28em] text-lime-200/64">{title}</h2>
