		...
		<section className="rounded-[2rem] border border-cyan-200/14 bg-cyan-300/[0.045] p-5 shadow-xl shadow-black/20 sm:p-6">
			...
			{!hasApplication ? (
				<div className="mt-5 rounded-2xl border border-amber-200/18 bg-amber-200/[0.07] p-4 text-sm text-amber-50/76">
					Speichere zuerst deine Turnierbewerbung, um eine Wunschgruppe zu erstellen oder ihr beizutreten.
				</div>
			) : group ? (
				...
				<div className="mt-5 grid gap-4 lg:grid-cols-2">
					...
					>
						...
						<p className="mt-1 text-xs leading-5 text-emerald-100/48">Den Code erhältst du direkt von einer Person aus der Wunschgruppe.</p>
