			...
			<header className="sticky top-0 z-50 border-b border-white/7 bg-[#020b07]/88 shadow-lg shadow-black/10 backdrop-blur-xl">
				<div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-5 py-4 sm:px-8">
					...
					<nav aria-label="Kontonavigation" className="flex items-center gap-2">
						<a
							href={`${apexUrl}/overlay`}
							className="hidden rounded-xl border border-white/10 bg-white/[0.035] px-4 py-2.5 text-[10px] font-black uppercase tracking-[0.16em] text-emerald-100/70 transition hover:border-cyan-200/30 hover:text-cyan-100 sm:inline-flex"
						>
							OBS-Tools
						</a>
						<a
							href={tournamentUrl}
							className="rounded-xl bg-gradient-to-r from-lime-200 via-emerald-200 to-cyan-200 px-4 py-2.5 text-[10px] font-black uppercase tracking-[0.16em] text-emerald-950 shadow-lg shadow-lime-300/10"
						>
							Turnier
						</a>
					</nav>
