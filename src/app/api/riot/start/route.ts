...
import { getAccountByRiotId, getSummonerByPuuid, parseRiotId, pickChallengeIcon, profileIconUrl, RiotApiError } from "@/lib/riot";
...
export async function POST(request: Request) {
	...
	try {
		...
		const summoner = await getSummonerByPuuid(account.puuid, { forceFresh: true });
