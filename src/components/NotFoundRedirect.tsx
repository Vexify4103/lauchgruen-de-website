...
export function NotFoundRedirect() {
	...
	return (
		<main className="relative flex min-h-screen items-center overflow-hidden bg-[#03100a] px-5 py-10 text-emerald-50">
			<div
				aria-hidden
				className="absolute inset-0 bg-[radial-gradient(circle_at_18%_20%,rgba(183,243,107,.13),transparent_34%),radial-gradient(circle_at_82%_78%,rgba(88,224,210,.12),transparent_36%)]"
			/>
			<div
				aria-hidden
				className="absolute inset-0 opacity-[0.13] [background-image:linear-gradient(rgba(183,243,107,.16)_1px,transparent_1px),linear-gradient(90deg,rgba(183,243,107,.16)_1px,transparent_1px)] [background-size:44px_44px]"
			/>

			<div className="relative mx-auto grid w-full max-w-4xl gap-5">
				<section className="relative w-full overflow-hidden rounded-[2rem] border border-lime-200/18 bg-[#08170f]/94 p-7 shadow-2xl shadow-black/45 sm:p-10">
